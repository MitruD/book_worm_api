...
namespace book_worm_api.Migrations
{
    ...
    [Migration("20240120140038_addOerderHeaderAndDetails")]
    partial class addOerderHeaderAndDetails
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("book_worm_api.Models.OrderDetails", b =>
                {
            ...
            modelBuilder.Entity("book_worm_api.Models.OrderHeader", b =>
                {
                    b.Property<int>("OrderHeaderId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("book_worm_api.Models.CartItem", b =>
                {
                    b.HasOne("book_worm_api.Models.MenuItem", "MenuItem")
                        .WithMany()
            ...
            modelBuilder.Entity("book_worm_api.Models.OrderDetails", b =>
                {
                    ...
                    b.HasOne("book_worm_api.Models.OrderHeader", null)
            ...
            modelBuilder.Entity("book_worm_api.Models.OrderHeader", b =>
                {
                    b.HasOne("book_worm_api.Models.ApplicationUser", "User")
                        .WithMany()
